...
// Profile picture uploader for PUT /auth/update-profile — the Edit Profile
// sheet already builds a multipart request with the file under this exact
// field name (see AuthRepository.updateProfile / EditProfileSheet on the
// Flutter side), but this route previously had no multer middleware at
// all, so the file was silently dropped and only the other text fields
// ever saved.
